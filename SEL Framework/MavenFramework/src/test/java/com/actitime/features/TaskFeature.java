...
public class TaskFeature {
	...
	public void  deleteCustomer(String username, String password, String CustomerName )
	{
		...
		Select sel = new Select(apcp.getCutomerDrpDwn());  // select class for drop down
		...
		Select sel2=new Select (apcp.getCutomerDrpDwn()); // creating select object again because page get refreshed and stale erro message appear for cutomdro down geetter
